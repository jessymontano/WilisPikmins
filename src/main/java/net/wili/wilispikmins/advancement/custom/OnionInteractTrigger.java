...
public class OnionInteractTrigger extends SimpleCriterionTrigger<OnionInteractTrigger.TriggerInstance> {
    @Override
    public @NotNull Codec<OnionInteractTrigger.TriggerInstance> codec() {
    ...
    public record TriggerInstance(
        ...
        public static Criterion<TriggerInstance> interactWithOnion() {
            return ModTriggers.ONION_INTERACT.get().createCriterion(
